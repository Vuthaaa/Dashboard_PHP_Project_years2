    ...
    if ($result) {
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if ($password == $confirm_password) {           
                ...
                $sql = "INSERT INTO admin(first_name, last_name , email, password ) VALUES('$Fname', '$Lname' ,'$email','$password')";
                mysqli_query($db, $sql);
                ...
                header("location: adminLogin.php");  //redirect home page
            } 
             else {
	...
	<div class="screen">
		<div class="screen__content">
            ...
            <h1>Create Account</h1>
                ...
                <br>
                <h5>Already have an account? <a href="adminLogin.php">Login here</a>.</h5>	
			</form>
